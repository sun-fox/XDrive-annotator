...
import "./index.css";
export default function AnnotatedDisplayer({match}) {
  ...
  useEffect(() => {
    setLoading(true);
    fetch('http://localhost:4000/get_annotated_images/'+match.params.folder).then((data)=>{return data.json()}).then((data)=>{
